...
<head>
    ...
    <title>Diana's Resort | Facilities</title>
</head>
<body class="bg-green-50">
        ...
        <nav class="navbar hidden sm:block py-2 fixed top-0 left-0 w-full z-50">
            ...
            <div class="2xl:p-10 p-5 nav-link-list flex justify-center items-center relative">
                <ul class="nav-container flex items-center 2xl:gap-7 xl:gap-2 gap-1 justify-center">
                    ...
                    <li>
                        <a href="facilities.php" class="nav-link link-active duration-1000 ease-in xl:text-xl lg:text-lg text-sm font-semibold text-green-50 bg-green-950 rounded-br-3xl rounded-tl-3xl px-3 py-2">FACILITIES</a>
                    </li>
                    <li>
    ...
    <div class="flex mt-5 gap-10 lg:mt-5 xl:mt-10 sm:gap-5 md:gap-0 p-5 flex-col sm:px-20 md:px-0">
        <div class="fade-in deluxe-room relative items-center flex flex-col md:flex-row">
            ...
            <div class="facilities-description sm:p-6 md:py-0 flex flex-col p-5 xl:px-10 md:w-3/6">
                <h1 class="text-green-950 font-bold md:text-lg lg:text-2xl text-xl xl:text-3xl mb-3">Deluxe Family Room</h1>
                <p class="text-green-900 text-sm sm:text-md md:text-lg text-justify">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Non a magnam quaerat cupiditate hic doloremque. Provident cupiditate doloribus accusamus, expedita placeat repellat quisquam commodi nam.
                </p>
            </div>
        </div>
    
        <div class="fade-in deluxe-room relative items-center flex flex-col md:flex-row">
            <div class="facilities-description sm:p-6 md:py-0 order-2 md:order-1 flex flex-col p-5 xl:px-10 md:w-3/6">
                <h1 class="text-green-950 font-bold md:text-lg lg:text-2xl text-xl xl:text-3xl mb-3">Deluxe Family Room</h1>
                <p class="text-green-900 text-sm sm:text-md md:text-lg text-justify">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Non a magnam quaerat cupiditate hic doloremque. Provident cupiditate doloribus accusamus, expedita placeat repellat quisquam commodi nam.
                </p>
        ...
        <div class="fade-in deluxe-room relative items-center flex flex-col md:flex-row">
            ...
            <div class="facilities-description sm:p-6 md:py-0 flex flex-col p-5 xl:px-10 md:w-3/6 md:order-2">
                <h1 class="text-green-950 font-bold md:text-lg lg:text-2xl text-xl xl:text-3xl mb-3">Deluxe Family Room</h1>
                <p class="text-green-900 text-sm sm:text-md md:text-lg text-justify">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Non a magnam quaerat cupiditate hic doloremque. Provident cupiditate doloribus accusamus, expedita placeat repellat quisquam commodi nam.
                </p>
