...
<head>
    ...
    <title>Diana's Resort | Gallery</title>
</head>
<body class="bg-green-50">
        ...
        <nav class="navbar hidden sm:block py-2 fixed top-0 left-0 w-full z-50">
            ...
            <div class="2xl:p-10 p-5 nav-link-list flex justify-center items-center relative">
                <ul class="nav-container flex items-center 2xl:gap-7 xl:gap-2 gap-1 justify-center">
                    ...
                    <li>
                        <a href="gallery.php" class="nav-link link-active duration-1000 ease-in xl:text-xl lg:text-lg text-sm font-semibold text-green-50 bg-green-950 rounded-br-3xl rounded-tl-3xl px-3 py-2">GALLERY</a>
                    </li>
                    <li>
    ...
    <div class="mt-10">
        <div class="fade-in flex flex-col justify-center items-center">
            <h1 class="text-lg font-bold text-green-950 sm:text-3xl md:text-4xl">MEMORIES WITH US</h1>
            <img src="assets/decoration/dark.png" alt="DECORATION" class="w-[100px] sm:w-[200px] sm:-mt-5 -mt-2 md:-mt-7">
        </div>

        <div class="flex justify-center flex-wrap px-5">
            <div class="fade-in w-1/2 md:w-[30%]">
