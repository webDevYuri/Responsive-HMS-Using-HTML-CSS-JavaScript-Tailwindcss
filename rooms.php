...
<head>
    ...
    <title>Diana's Resort | Rooms</title>
</head>
    ...
    <div class="my-10">
        <div class="px-5 lg:flex flex-wrap">
            <div class="fade-in relative lg:w-1/2 w-full">
                <img src="assets/rooms/roomOne.jpg" alt="ROOM ONE">
                <button class="w-[180px] py-2 text-sm text-green-50 absolute top-1/2 left-1/2 transform -translate-x-1/2 bg-green-950 bg-opacity-50 hover:bg-opacity-100 duration-200 ease-in border-2 border-green-50">STANDARD ROOM</button>
            </div>
            <div class="fade-in relative lg:w-1/2 w-full">
                <img src="assets/rooms/roomTwo.jpg" alt="ROOM TWO">
                <button class="w-[180px] py-2 text-sm text-green-50 absolute top-1/2 left-1/2 transform -translate-x-1/2 bg-green-950 bg-opacity-50 hover:bg-opacity-100 duration-200 ease-in border-2 border-green-50">EXECUTIVE ROOM</button>
            </div>
            <div class="fade-in relative lg:w-1/2 w-full">
                <img src="assets/rooms/roomThree.jpg" alt="ROOM THREE">
